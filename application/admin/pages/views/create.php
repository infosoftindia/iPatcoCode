											...
											<div class="card">
												...
												<div class="card-body">
													<div class="form-group mb-3">
														...
														<input type="text" class="form-control" id="name" placeholder="Page Title" value="<?=set_value('title')?>" name="title">
													</div>
													<div class="form-group mh-150px mb-3">
														<label for="desc" class="mb-3">Page Content</label>
														<textarea class="form-control editor" id="desc" rows="6" placeholder="Page Content" name="description"><?=set_value('description')?></textarea>
													</div>
												</div>
											</div>
										</div>
